...
export class AiOrchestrator {
  static async handleChat(userId: string, restaurantId: string, message: string, conversationId?: string) {
  ...
  private static async generateResponse(input: string, restaurantId: string): Promise<string> {
