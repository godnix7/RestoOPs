...
$Migrations = @(
    ...
    "packages/db/migrations/006_external_integrations.sql",
    "packages/db/migrations/007_mfa_support.sql",
    "packages/db/migrations/008_rls_hardening.sql",
    "packages/db/migrations/009_rls_core_features.sql"
)
